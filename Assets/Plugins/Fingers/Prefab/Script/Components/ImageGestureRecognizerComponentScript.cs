...
namespace DigitalRubyShared
{
    ...
    public class ImageGestureRecognizerComponentScript : GestureRecognizerComponentScript<ImageGestureRecognizer>
    {
        ...
        /// <summary>The images that should be compared against to find a match. The values are a ulong which match the bits of each generated image. See DemoSceneImage &amp; DemoScriptImage.cs for an example.</summary>
    ...
    public struct ImageGestureRecognizerComponentScriptImageEntry
    {
        ...
        /// <summary>Comma separated list of hex format ulong for each row, separated by newlines.</summary>
        [TextArea(1, 8)]
